...
const ThemeSettings = () => {
  ...
  return (
    <div className="bg-neutral-800 w-screen fixed nav-item top-0 right-0">
      <div className="float-right h-screen dark:text-gray-200 bg-white dark:[#484B52] w-400">
        <div className="flex justify-between items-center p-4 ml-4">
          <p className="font-semibold text-xl">Settings</p>
          <button type="button" onClick={() => setThemeSettings(false)} style={{color: "rgb(153, 171, 180)", borderRadius: "50%"}} className="text-2xl p-3 hover:drop-shadow-xl hover:bg-gray-50"><MdOutlineCancel/></button>
        </div> 
        <div className="flex-col border-t-2 border-zinc-800 p-4 ml-4">
        ...
        <div className="flex-col border-t-2 border-zinc-800 p-4 ml-4">
          ...
          <div className="flex gap-3">
            {themeColors.map((item) => (
              <TooltipComponent key={uuidv4()} content={item.name} position="TopCenter">
