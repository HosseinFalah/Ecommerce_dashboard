    ...
    <div className="nav-item absolute right-5 md:right-52 top-16 bg-white dark:bg-[#42464D] p-8 rounded-lg w-96">
      <div className="flex justify-between items-center">
        ...
        <TooltipComponent content="Menu" position="BottomCenter">
              <button type="button" onClick={() => handleClick(!true)} className="text-xl rounded-full p-3 hover:dark:bg-slate-200 mt-4 md:block sm:hidden hover:dark:text-black dark:text-white hover:bg-slate-100">
                <MdOutlineCancel/>
              </button>
        </TooltipComponent>
      </div>
